module Bitcodin
  class Job
    ...
    def initialize(inputId, encodingProfileId, manifestTypes, speed=nil, outputId=nil, drmConfig=nil, hlsEncryptionConfig=nil, audioMetaDataConfigs=nil, location=nil, videoMetaData=nil, extractClosedCaptions=nil)
      @values = '{'
